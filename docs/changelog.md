...
### 2026-02-26 [项目迁移] 从 OpenClaw 迁移到 Cat Café

**背景**: 将 bot_civ (OpenClaw) 项目的通用文档迁移到当前 Cat Café 项目

**删除的 OpenClaw 特定内容**:
- `docs/specs/SPEC-001-核心系统/` - OpenClaw 功能规格（~35 个文件）
- `docs/PRD.md` - OpenClaw 产品需求文档
- `docs/PLAN-agent-autonomy.md` - Agent 自主性方案
- `docs/AUDIT-REPORT.md` - OpenClaw 审计报告
- `docs/decisions/` - OpenClaw 决策记录
- `docs/tests/` - OpenClaw 测试文档
- `docs/discussions/` 中的 OpenClaw 特定讨论（~10 个文件）

**保留的通用内容**:
- `docs/runbooks/error-books/` - 错题本系统（通用）
- `docs/runbooks/postmortems/` - 事后分析（通用）
- `docs/workflows/` - 工作流 checklist（通用）
- `docs/personas/` - 五方评审角色（通用）
- `docs/lessons/` - Cat Café 教程（核心资产）
- `docs/templates/` - 文档模板（通用）

**更新的文件**:
- `CLAUDE.md` - 适配 Cat Café 项目结构
- `docs/CODE_MAP.md` - 更新为 Cat Café 代码导航
- `docs/api-contract.md` - 更新为 Cat Café API 契约
- `docs/discussions.md` - 清理无效引用
- `docs/PROGRESS_FILES.md` - 简化为当前项目结构
- `docs/ROADMAP.md` - 新建功能路线图
- `claude-progress.txt` - 新建进度追踪文件
